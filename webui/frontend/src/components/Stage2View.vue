...
const stats = computed(() => store.stage2Stats);
const allQuestions = computed(() => store.stage2FilteredQuestions);
const pageQuestions = computed(() => store.stage2PaginatedQuestions);
const page = computed(() => store.stage2Page);
...
watch(
  () => [
    store.stage2Search,
    store.stage2LevelFilter,
    store.stage2TypeFilter,
    store.stage2DiffFilter,
  ],
  () => {
    store.stage2Page = 1;
  }
    ...
    >
      ...
      >
        ...
        <div class="flex flex-wrap items-center gap-2 w-full sm:w-auto">
          ...
          />
          <select
            v-model="store.stage2LevelFilter"
          ...
          <select
            v-model="store.stage2TypeFilter"
            class="px-2 py-1.5 border border-slate-200 rounded-lg text-xs text-slate-600 bg-white cursor-pointer"
          >
          ...
          <select
            v-model="store.stage2DiffFilter"
            class="px-2 py-1.5 border border-slate-200 rounded-lg text-xs text-slate-600 bg-white cursor-pointer"
          >
